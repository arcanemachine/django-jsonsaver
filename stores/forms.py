...
class JsonStoreForm(forms.ModelForm):
    ...
    def clean(self):
        ...
        if invalidators.public_jsonstore_name_cannot_be_blank(name, is_public):
        ...
        if invalidators.forbidden_jsonstore_name_not_allowed(name):
            self.add_error('name', ValidationError(
        ...
        if invalidators.user_has_too_many_stores(
            ...
            self.add_error(None, ValidationError(
                ...
                params={'user_max_jsonstore_count': user_max_jsonstore_count}))
        ...
        if invalidators.jsonstore_public_name_duplicate_other_user(
        ...
        if invalidators.all_jsonstores_data_size_over_max(
                user, jsonstore_data_size):
            self.add_error('data', ValidationError(
